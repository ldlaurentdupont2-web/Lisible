...
export const CATEGORIES = {
  administratif: {
    ...
    emoji: '🏛️',
    description: 'CAF, impôts, Pôle emploi, préfecture…',
    price: 390,
    priceLabel: '3,90 €',
  },
  paie: {
    ...
    emoji: '💶',
    description: 'Comprendre votre fiche de salaire',
    price: 390,
    priceLabel: '3,90 €',
  },
  bail: {
    ...
    label: 'Bail locatif',
    emoji: '🏠',
    description: 'Contrat de location, clauses, droits',
    price: 590,
    priceLabel: '5,90 €',
  },
  contrat: {
    ...
    emoji: '📋',
    description: "CDI, CDD, clauses, periode d'essai",
    price: 590,
    priceLabel: '5,90 €',
  },
  huissier: {
    ...
    emoji: '⚖️',
    description: 'Actes, saisies, commandements',
    price: 790,
    priceLabel: '7,90 €',
  },
}
