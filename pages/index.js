            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <a href="/blog" className="text-xs text-terracotta hover:underline">Voir tous →</a>
                </div>
                {[
                  ...
                  <a key={article.slug} href={`/blog/${article.slug}`} className="flex items-start gap-4 bg-white border border-border-soft rounded-2xl p-4 hover:border-terracotta/30 hover:shadow-sm transition-all group">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold text-text-primary group-hover:text-terracotta transition-colors leading-snug">{article.titre}</p>
                      <p className="text-xs text-text-secondary mt-1 leading-relaxed">{article.desc}</p>
                    </div>
